...
const listingSchema = new Schema({
  ...
  // FIX: Added the category field to map to your index.ejs filters
  category: {
    type: String,
    enum: ["Trending", "Rooms", "Iconic Cities", "Surfing", "Beach", "Cabins", "Farms", "Amazing Pools", "Lakefront", "Castles", "Camping", "Boats"]
  },
